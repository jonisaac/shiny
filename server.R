function(input, output) {
  ...
  #   col_account_mat <- matrix(nrow = length(accounts), ncol = nrow(search))
  #    col_account_mat_amount <- matrix(nrow = length(accounts), ncol = nrow(search))
  # dim(col_account_mat)
  #for(j in 1:length(accounts)){
  #    account_df <- payments[payments$acc_num == accounts[j], ]
